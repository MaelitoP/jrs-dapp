                    ...
                    <div className="mb-3 space-y-2 w-3/4 text-xs mx-auto">
                      <div className="">
                        ...
                        <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-2 ">
                          <button
                            className="bg-gray-200 text-grey-darker hover:text-gray-700 hover:bg-gray-300 h-full w-20 rounded-l-lg cursor-pointer outline-none"
                            onClick={() => {
                              if (mintNumber != 0)
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              if (value >= 0) setMintNumber(value);
                            }}
                          ></input>
                          <button
                            className="bg-gray-200 text-grey-darker hover:text-gray-700 hover:bg-gray-300 h-full w-20 rounded-r-lg cursor-pointer"
                            onClick={() => {
                              setMintNumber(mintNumber + 1);
                            }}
                          >
